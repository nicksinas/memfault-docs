...
sidebar_label: MCUXpresso RT1060 Guide
---
...
on ubuntu 22.04, using the MIMXRT1060-EVKB
([https://www.mouser.com/pdfDocs/NXP_MIMXRT1060-EVKB_QS.pdf](https://www.mouser.com/pdfDocs/NXP_MIMXRT1060-EVKB_QS.pdf)).
...
3. (optional, for RT1060 network demo) Add the example port files for the RT1060
   LwIP port, and configure Memfault Project Key for uploading Memfault data
   from the EVK
...
3. to see decoded data on app.memfault.com, the Symbol File will need to be
   ...
   be uploaded through the Memfault web ui or using the Memfault CLI tool:
   [https://docs.memfault.com/docs/mcu/symbol-file-build-ids/#upload-symbol-files-cli](https://docs.memfault.com/docs/mcu/symbol-file-build-ids/#upload-symbol-files-cli)
