...
Some products might consist of multiple Android devices connected together,
where not all of the devices have direct internet access - this presents a
challenge uploading diagnostics (and downloading settings) from the un-connected
_companion_ devices.

The Bort SDK (since version 4.0) supports offloading data the _companion_
...
Data is bundled together in a MAR archive. This zipped file format collects
